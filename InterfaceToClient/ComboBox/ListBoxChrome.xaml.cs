...
namespace InterfaceToClient
{
    ...
    ///
    /// </summary>
    public partial class ListBoxChrome : Decorator
    {
        #region Constructors
        ...
        /// </summary>
        /// <param name="availableSize">Available size is an "upper limit" that the return value should not exceed.
        ...
        /// </remarks>
        /// <param name="finalSize">Size the ContentPresenter will assume.
